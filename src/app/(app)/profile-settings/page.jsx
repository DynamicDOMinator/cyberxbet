        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row-reverse items-start sm:items-center justify-between gap-3">
            ...
            <div className="flex-1 mx-0 sm:mx-4 w-full">
              <input
                type="text"
                value={
                  socialAccounts.instagram ? socialAccounts.instagram.value : ""
                }
                onChange={(e) =>
            ...
            <div className="flex gap-4 items-center justify-center order-first sm:order-none">
              ...
              <Image
                src={
                  socialAccounts.instagram && socialAccounts.instagram.linked
                    ? "/linked.png"
                    : "/unlinked.png"
                }
                alt="connection status"
          ...
          <div className="flex flex-col sm:flex-row-reverse items-start sm:items-center justify-between gap-3">
            <button
              ...
              disabled={
                socialAccounts.tiktok.linking || socialAccounts.tiktok.unlinking
              }
            >
            ...
            <div className="flex gap-4 items-center justify-center order-first sm:order-none">
              ...
              <Image
                src={
                  socialAccounts.tiktok.linked ? "/linked.png" : "/unlinked.png"
                }
                alt="connection status"
                width={20}
                height={20}
              ...
              <div className="flex gap-4 mt-4">
                ...
                >
                  {verifyingOtp ? (
                    ...
                    <span>{isEnglish ? "Verify OTP" : "تحقق من الرمز"}</span>
                  )}
                </button>
                ...
                <div className="w-full">
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-xs text-gray-400">
                      {isEnglish ? "Password strength:" : "قوة كلمة المرور:"}
                    </span>
                    <span
