      ...
      <div className=" lg:px-16 px-5">
        <div dir={isEnglish ? "ltr" : "rtl"} className="mb-8">
          ...
          <div className={`flex justify-${isEnglish ? "end" : "start"} mt-10`}>
            <div className="flex items-center bg-white/5   px-3 py-2 w-64">
              <FiSearch
        ...
        >
          {/* Table Headers */}
          <div className="grid grid-cols-5 gap-4 mb-9 px-4 bg-[#38FFE50D] py-3 rounded-md">
          ...
          {leaderboardData.map((user, index) => (
            <div
              key={index}
              className={`rounded-lg mb-3 px-4 py-3 ${
